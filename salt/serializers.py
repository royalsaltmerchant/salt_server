...
class UserSchema(ma.SQLAlchemySchema):
    class Meta:
        model = User
        fields = ("id", "active", "first_name", "last_name", "username", "admin", "email", "password", "approved_asset_count", "coins", "contributions")
...
class TrackAssetSchema(ma.SQLAlchemySchema):
    class Meta:
        model = TrackAsset
        fields = ("id", "name", "length", "waveform", "audio_metadata", "active")
